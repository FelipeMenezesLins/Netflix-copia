...
NPM_BIN_PATH = "C:/Users/felip/AppData/Roaming/npm/npm.cmd"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'filme.context.categorias_destaques',
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # pasta onde os arquivos vão ser coletados
